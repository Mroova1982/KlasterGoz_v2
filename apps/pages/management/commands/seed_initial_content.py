...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not footer.legal_links:
            footer.legal_links = [
                {"type": "link", "value": {"label": "RODO", "page": None, "url": "/rodo/", "description": ""}},
                {"type": "link", "value": {"label": "Regulamin", "page": None, "url": "/regulamin/", "description": ""}},
                {"type": "link", "value": {"label": "Cookies", "page": None, "url": "/cookies/", "description": ""}},
            ]
            footer.save()
